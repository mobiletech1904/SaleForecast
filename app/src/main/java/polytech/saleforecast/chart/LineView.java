package polytech.saleforecast.chart;
...
/*
 * Немного переписанная либа для рисования графика :)
 */
public class LineView extends View {
    private int globalPredictionPeriod;
    public int getGlobalPredictionPeriod() {
        return globalPredictionPeriod;
    }

    public void setGlobalPredictionPeriod(int globalPredictionPeriod) {
        this.globalPredictionPeriod = globalPredictionPeriod;
    }

    private ArrayList<Double> conversionRateList = new ArrayList<Double>();
    public ArrayList<Double> getConversionRateList() {
        return conversionRateList;
    }

    public void setConversionRateList(ArrayList<Double> conversionRateList) {
    ...
    private void drawLines(Canvas canvas){
        ...
        for(int k = 0; k<drawDotLists.size(); k ++){
            ...
            for (int i = 0; i < drawDotLists.get(k).size() - 1; i++) {
                ...
                if(i >= (drawDotLists.get(k).size()-1)-globalPredictionPeriod) {
     ...
     private void drawBackgroundLines(Canvas canvas){
      ...
      if(bottomTextList != null){
    	  for(int i=0;i<bottomTextList.size();i++) {
              ...
              bottomTextPaint.setTextSize(30.0f);
              ...
              bottomTextPaint.setTextSize(26.0f);
              bottomTextPaint.setColor(Color.BLACK);
              bottomTextPaint.setTypeface(Typeface.create(Typeface.DEFAULT, Typeface.NORMAL));

              canvas.drawText(conversionRateList.get(i) + "", sideLineLength + backgroundGridWidth * i, mViewHeight - 78, bottomTextPaint);
          }
